...
def do_coco_evaluation(dataset, predictions, output_folder, iou_type, expected_results,
...
class COCOResults(object):
    def __init__(self):
        self.metrics = {"bbox": ["AP", "AP50", "AP75", "APs", "APm", "APl"]}
        self.results = OrderedDict()
        self.results['bbox'] = OrderedDict([(metric, -1) for metric in self.metrics['bbox']])
